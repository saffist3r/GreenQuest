						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12 text-center">
								...
								<form action="conn.php" method="POST">
			                                ...
			                                <input type="email" class="form-control" name="email" placeholder="Enter email" required="required" style="width:300px;" />
				                       		<br><br>
				                            <input type="password" class="form-control" name="mdp" placeholder="Entrer un mot de passe" required="required"  style="width:300px;" />
				                        
					                        <input type="submit" class="btn btn-primary" id="btnContactUs" value="Connecter">
